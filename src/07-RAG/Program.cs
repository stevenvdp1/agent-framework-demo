...
var agent = client.AsAIAgent(
    ...
    instructions: """
        ...
        You have access to the conference schedule with all talks, speakers, and session details.
        Use the SearchTechorama tool to look up talks by speaker, topic, date, room, or difficulty.
